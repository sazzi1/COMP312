...
public class GamePanel extends JPanel implements ActionListener{
		...
		if(running) {
			...
			for(int i = 0; i < bodyParts; i++ ) {
				if(i == 0) {
					...
					//g.fillRoundRect(x[i], y[i], UNIT_SIZE, UNIT_SIZE, UNIT_SIZE + 2, UNIT_SIZE + 2);//NEW HEAD?		
			...
			g.setColor(new Color(181, 25, 25));
	...
	public void playTune() {
		String filepath = "src/warpDrive.wav";
		musicTools player = new musicTools();
	...
	public void checkCollisions() {
		...
		//check if I can just loop around 
